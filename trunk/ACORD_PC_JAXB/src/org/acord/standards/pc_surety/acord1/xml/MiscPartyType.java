 ...
 *         &lt;element ref="{http://www.ACORD.org/standards/PC_Surety/ACORD1/xml/}MiscPartyInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class MiscPartyType {
    ...
    protected List<MiscPartyInfoType> miscPartyInfo;
     ...
     * {@link MiscPartyInfoType }
     * 
     * 
     */
    public List<MiscPartyInfoType> getMiscPartyInfo() {
        if (miscPartyInfo == null) {
            miscPartyInfo = new ArrayList<MiscPartyInfoType>();
        }
