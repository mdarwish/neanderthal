...
/**
 * <p>Java class for AdjusterParty_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AdjusterParty_Type">
 *   &lt;complexContent>
 ...
 *         &lt;element ref="{http://www.ACORD.org/standards/PC_Surety/ACORD1/xml/}AdjusterPartyInfo" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "AdjusterParty_Type", propOrder = {
    "itemIdInfo",
    "generalPartyInfo",
    "adjusterPartyInfo"
})
public class AdjusterPartyType {
    ...
    @XmlElement(name = "AdjusterPartyInfo")
    protected List<AdjusterPartyInfoType> adjusterPartyInfo;
    ...
    /**
     * Gets the value of the adjusterPartyInfo property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the adjusterPartyInfo property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAdjusterPartyInfo().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AdjusterPartyInfoType }
     * 
     * 
     */
    public List<AdjusterPartyInfoType> getAdjusterPartyInfo() {
        if (adjusterPartyInfo == null) {
            adjusterPartyInfo = new ArrayList<AdjusterPartyInfoType>();
        }
        return this.adjusterPartyInfo;
    }
