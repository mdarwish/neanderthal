...
/**
 * <p>Java class for SuretyBondTransactionInqInfo_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="SuretyBondTransactionInqInfo_Type">
 *   &lt;complexContent>
 ...
 *         &lt;element ref="{http://www.ACORD.org/standards/PC_Surety/ACORD1/xml/}SuretyBondTransactionInfo" maxOccurs="unbounded"/>
...
@XmlType(name = "SuretyBondTransactionInqInfo_Type", propOrder = {
    "insuredOrPrincipal",
    "suretyBondTransactionInfo",
    "accountNumberId"
})
public class SuretyBondTransactionInqInfoType {

    @XmlElement(name = "InsuredOrPrincipal")
    protected List<InsuredOrPrincipalType> insuredOrPrincipal;
    @XmlElement(name = "SuretyBondTransactionInfo", required = true)
    protected List<SuretyBondTransactionInfoType> suretyBondTransactionInfo;
    ...
    /**
     * Gets the value of the suretyBondTransactionInfo property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the suretyBondTransactionInfo property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSuretyBondTransactionInfo().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SuretyBondTransactionInfoType }
     * 
     * 
     */
    public List<SuretyBondTransactionInfoType> getSuretyBondTransactionInfo() {
        if (suretyBondTransactionInfo == null) {
            suretyBondTransactionInfo = new ArrayList<SuretyBondTransactionInfoType>();
        }
        return this.suretyBondTransactionInfo;
    }
