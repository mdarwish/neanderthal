...
/**
 * <p>Java class for BoilerMachineryInfo_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BoilerMachineryInfo_Type">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element ref="{http://www.ACORD.org/standards/PC_Surety/ACORD1/xml/}CommlCoverage" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.ACORD.org/standards/PC_Surety/ACORD1/xml/}StatementValuesInfo" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "BoilerMachineryInfo_Type", propOrder = {
    "commlCoverage",
    "statementValuesInfo",
    "sicCd",
    "naicsCd",
...
public class BoilerMachineryInfoType {

    @XmlElement(name = "CommlCoverage")
    protected List<CommlCoverageType> commlCoverage;
    @XmlElement(name = "StatementValuesInfo")
    protected List<StatementValuesInfoType> statementValuesInfo;
    ...
    /**
     * Gets the value of the statementValuesInfo property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the statementValuesInfo property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getStatementValuesInfo().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link StatementValuesInfoType }
     * 
     * 
     */
    public List<StatementValuesInfoType> getStatementValuesInfo() {
        if (statementValuesInfo == null) {
            statementValuesInfo = new ArrayList<StatementValuesInfoType>();
        }
        return this.statementValuesInfo;
    }
