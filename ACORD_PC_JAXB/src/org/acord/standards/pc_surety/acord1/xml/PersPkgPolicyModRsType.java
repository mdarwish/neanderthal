...
/**
 * <p>Java class for PersPkgPolicyModRs_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="PersPkgPolicyModRs_Type">
 *   &lt;complexContent>
 ...
 *         &lt;element ref="{http://www.ACORD.org/standards/PC_Surety/ACORD1/xml/}PersPkgPolicy" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "PersPkgPolicyModRs_Type", propOrder = {
    "rqUID",
...
public class PersPkgPolicyModRsType {
    ...
    protected List<PersPkgPolicyType> persPkgPolicy;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the persPkgPolicy property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPersPkgPolicy().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PersPkgPolicyType> getPersPkgPolicy() {
        if (persPkgPolicy == null) {
            persPkgPolicy = new ArrayList<PersPkgPolicyType>();
        }
        return this.persPkgPolicy;
    }
